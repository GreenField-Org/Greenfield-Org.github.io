...
export default function Home() {
  return (
    <main>
      <div className='flex w-[1440px] h-[900px] flex-col items-center gap-20 px-16 py-0'>
        <div className='flex items-center flex-[1_0_0] self-stretch'>
          <div className='flex flex-col justify-center items-start gap-6 flex-[1_0_0] self-stretch pr-0'>
            <div className='flex flex-col items-start gap-6 self-stretch'>
              <h1 className='self-stretch text-[56px] not-italic font-bold leading-[120%]'>Empowering Innovation Through Inclusive Software Development</h1>
              <p className='self-stretch text-lg not-italic font-normal leading-[150%]'>At GreenField Dev, we are a LGBTQIA+ owned software development company dedicated to creating innovative solutions that drive positive change. With our expertise and commitment to social good, we work closely with our clients to meet their goals in a safe and respectful space.</p>
            </div>
            <div className='flex items-start gap-4 pt-4'>
              <button className='flex justify-center items-center gap-2 border px-6 py-3 border-solid border-black'>Learn More</button>
            </div>
          </div>
          <div className='flex h-[900px] items-start gap-4 flex-[1_0_0]'>
          ...
          <div className='flex flex-col items-start gap-6 flex-[1_0_0]'>
            <div className='flex flex-col items-start gap-8 self-stretch'>
              <div className='flex flex-col items-start gap-4 self-stretch'>
                ...
                <h2 className='self-stretch  text-5xl not-italic font-bold leading-[120%]'>unlocking Potention through LGBTQIA+ Driven Software Solutions</h2>
      ...
      <div className='flex w-[1440px] flex-col items-center gap-20 px-16 py-28'>
        <div className='flex items-center gap-20 self-stretch'>
          <div className='h-[640px] flex-[1_0_0]'></div>
      ...
      <div className='flex w-[1440px] flex-col items-start gap-20 px-16 py-28'>
        <div className='flex items-center gap-20 self-stretch'>
          ...
          <button className='flex justify-center items-center gap-2 border px-6 py-3 border-solid border-black'>Contact</button>
          <button className='flex justify-center items-center gap-2 border px-6 py-3 border-solid border-black'>Get Started</button>
        </div>
        </div>
      </div>
