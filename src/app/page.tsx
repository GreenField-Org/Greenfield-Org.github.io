    ...
    <main>
      ...
      <Container>
        <div className='flex items-center gap-12 lg:gap-20 self-stretch'>
          <Tabs>
            <Tab title='Custom Software Development' description='We create tailored software solutions that meet your unique business needs. Our team of experienced developers will work closely with you to ensure a successful outcome.' />
            <Tab title='Mobile App Development' description={`We specialize in developing mobile applications for iOS and Android platforms. Our apps are user-friendly, visually appealing, and designed to enhance your brand's presence.`} />
            <Tab title='Web Development' description='Our web development services cover everything from creating responsive websites to building complex web applications. We focus on delivering high-quality solutions that drive results.' />
          </Tabs>
          ...
          <div className='flex flex-col items-start gap-6 flex-[1_0_0]'>
            <div className='flex flex-col items-start gap-8 self-stretch'>
              <div className='flex flex-col items-start gap-4 self-stretch'>
                ...
                <h2 className='self-stretch text-4xl lg:text-5xl not-italic font-bold leading-[120%]'>Unlocking Potential through Innovative Software Solutions</h2>
            ...
            <div className='flex items-start gap-6 self-stretch px-0 py-2'>
              <div className='flex flex-col items-start gap-2 flex-[1_0_0]'>
                <h2 className='self-stretch text-4xl lg:text-5xl not-italic font-bold leading-[120%]'>50%</h2>
